...
#Generalized linear model
glm.fit = glm(output ~ cp+sex+caa, data = 
                BANA_Comp_Data.cleaned ,family = binomial)
glm.fit
summary(glm.fit)
...
#cp vs output
plot(BANA_Comp_Data.cleaned$cp, glm.probs, xlab = 'chest pain', ylab =
       'chance of heart attack')
title('relationship of cp and output')


#caa vs output
plot(as.factor(BANA_Comp_Data.cleaned$caa), glm.probs, xlab = 'caa', ylab =
       'chance of heart attack')
title('relationship of caa and output')


#sex vs output
plot(BANA_Comp_Data.cleaned$sex, glm.probs, xlab = 'sex', ylab =
       'chance of heart attack')
title('relationship of sex and output')

#thall vs output
plot(BANA_Comp_Data.cleaned$thall, glm.probs, xlab = 'thall', ylab = 
       'chance of heart attack')
